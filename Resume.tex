...
\begin{document}
	...
	\cventry{}{AB InBev}{Staff Machine Learning Engineer}{}{July 2022 -- September 2025}{\textbf{Technologies:} Python, Tensorflow, Unit-Testing, CI/CD, C++ \\
		\cvlistitem{Provided model speedups and memory usage reductions in excess of 100x.}
		\cvlistitem{Led a team to migrate code to modern frameworks which we could further iterate on sustainably.}
		\cvlistitem{Embedded mathematical guarantees of business principles in the model architecture of the model greatly improving statistical performance.}
		\cvlistitem{Built a distributed framework to optimize marketing budgets across multiple axes and constraints with low latency.}
	    \cvlistitem{Helped develop image stitching and recognition software for use by field technicians using iOS devices.}}
